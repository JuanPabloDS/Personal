...
admin.site.register(PrecosPlano1, LimitAdmin)
admin.site.register(PrecosPlano1Dados)
admin.site.register(PrecosPlano2, LimitAdmin)
admin.site.register(PrecosPlano2Dados)
admin.site.register(Imagem, LimitAdmin)
admin.site.register(ImagensLista)
admin.site.register(Duvidas, LimitAdmin)
admin.site.register(DuvidasRespostas)
admin.site.register(Contato, LimitAdmin)
...
admin.site.register(Detalhes,DetalhesCoresAdmin, LimitAdmin)
