...
class Precos(Base):
    ...
    cor_fundo = models.CharField(max_length=7, validators=[cor_validator])
    cor_texto = models.CharField(max_length=7, validators=[cor_validator])
...
class Cores(Base):
    ...
    cor_sobre_background = models.CharField(max_length=7, validators=[cor_validator])
    cor_sobre_h1 = models.CharField(max_length=7, validators=[cor_validator])
    cor_details_background = models.CharField(max_length=7, validators=[cor_validator])
    cor_details_titulo = models.CharField(max_length=7, validators=[cor_validator])
    cor_details_p = models.CharField(max_length=7, validators=[cor_validator])
    cor_price_background = models.CharField(max_length=7, validators=[cor_validator])
    cor_price_h1 = models.CharField(max_length=7, validators=[cor_validator])
    cor_price_p = models.CharField(max_length=7, validators=[cor_validator])
    ...
    cor_imagem_background = models.CharField(max_length=7, validators=[cor_validator])
    cor_imagem_h1 = models.CharField(max_length=7, validators=[cor_validator])
    cor_question_background = models.CharField(max_length=7, validators=[cor_validator])
    cor_question_h1 = models.CharField(max_length=7, validators=[cor_validator])
    cor_question_p = models.CharField(max_length=7, validators=[cor_validator])
    ...
    cor_contact_background = models.CharField(max_length=7, validators=[cor_validator])
    cor_contact_h1 = models.CharField(max_length=7, validators=[cor_validator])
    cor_contact_p = models.CharField(max_length=7, validators=[cor_validator])
